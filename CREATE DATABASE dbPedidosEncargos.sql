...
GO
CREATE PROCEDURE UDP_tbfabrica_Update
    @fab_id INT,
    @fab_Nombre NVARCHAR(150),
    @mun_Id CHAR(4),
    @fab_Telefono NVARCHAR(20),
...
INSERT INTO [dbo].[tbClientes]
           ...
           ,[cli_Estado])
     VALUES
           ('Daniel','Espinoza','0501','32723854','daniele@gmail.com',100,400,0.05,GETDATE(),1,null,NULL,1)
...
--Pedidos
go
EXEC UDP_tbPedidos_Insert 1,1, 10,'E',1
go
EXEC UDP_tbPedidos_Insert 1,1, 1,'E',1
go
EXEC UDP_tbPedidos_Insert 1,1, 2,'E',1
go
EXEC UDP_tbPedidos_Insert 1,1, 9,'E',1
go
