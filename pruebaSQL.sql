...
CREATE TABLE tbRolesXPantalla(
	...
	CONSTRAINT PK_dbo_tbRolesXPantalla_rol_id PRIMARY KEY (rol_id),
...
VALUES
(
    'Municipios', -- pan_Nombre - NVARCHAR
    1, -- pan_UsuarioCreacion - INT
    GETDATE(), -- pan_FechaCreacion - DATETIME
    null, -- pan_UsuarioModificacion - INT
    null, -- pan_FechaModificacion - DATETIME
    1 -- pan_Estado - BIT
)
...
VALUES
(
    'Admin', -- rol_Nombre - NVARCHAR
    1, -- rol_UsuarioCreacion - INT
    GETDATE(), -- rol_FechaCreacion - DATETIME
    NULL, -- rol_UsuarioModificacion - INT
    NULL, -- rol_FechaModificacion - DATETIME
    1 -- rol_Estado - BIT
)	
...
--           ,[fab_FechaCreacion]
--           ,[fab_UsuarioCreacion]
--           ,[fab_FechaModificacion]
--           ,[fab_UsuarioModificacion]
--           ,[fab_Estado])
--     VALUES
--           ('The Willy Wonka Candy Company' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('Apple' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('Saudi Aramco' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('Microsoft' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('Alphabet (Google)' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('Amazon' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('Tesla' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('Meta (Facebook)' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('Berkshire Hathaway' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1),
--			('TSMC' ,'0501',1,'55484578',GETDATE(),1,NULL ,NULL,1)
